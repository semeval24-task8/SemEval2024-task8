...
tasks = {}
tasks["B"] = {}
tasks["B"]["train_data"] = "/Users/phenningsson/tfidfcalc/SubtaskB/subtaskB_train.jsonl"
tasks["B"]["dev_data"] = "/Users/phenningsson/tfidfcalc/SubtaskB/subtaskB_dev.jsonl"

train_data = pandas.read_json(tasks["B"]["train_data"], lines=True)
dev_data = pandas.read_json(tasks["B"]["dev_data"], lines=True)
...
sp.save_npz('tfidf_features_B_multi_dev.npz', tfidf_matr)